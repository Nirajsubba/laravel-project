                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        @foreach ($records as $row)
                          <tr class="even pointer">
                            ...
                            <td class=" ">{{$row->meta_keyword}} </td>
                            <td class=" ">{{$row->meta_description}} </td>
                            <td class=" last">
                          <a href="/admin/page/{{ $row->id }}/edit" class="btn btn-primary">Edit</a>
                          

                          <form method="post" action="/admin/page/{{ $row->id }}">
