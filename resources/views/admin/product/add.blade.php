        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <!-- error displaying from validation(product controller)  -->
              @if($errors->any())
              @foreach($erors->all() as $e)
              <ul>
                <li>{{ $e }}</li>
              </ul>
              @endforeach
              ...
              <form id="demo-form2" data-parsley-validate="" method="post" class="form-horizontal form-label-left" action="{{route('product.store')}}" novalidate="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10 col-sm-6 col-xs-12">
                    <input id="title" name="price" required="required" class="form-control col-md-7 col-xs-12" type="text">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10 col-sm-6 col-xs-12">
                    <textarea id="title" name="content" required="required" class="form-control col-md-7 col-xs-12" type="text"></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10 col-sm-6 col-xs-12">
                    <input id="title" type="file" name="image" required="required" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>
