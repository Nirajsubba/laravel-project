      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br>
              <form id="demo-form2" data-parsley-validate="" method="post" class="form-horizontal form-label-left" action="{{route('product.update', $row->id)}}" novalidate="" enctype="multipart/form-data">
              ...
              <!-- https://laravelcollective.com/docs/5.4/html -->
                ...
                <div class="form-group">
                  <label class="control-label col-md-2 col-sm-3 col-xs-12" for="first-name">Brand <span class="required">*</span>
                  </label>
                  <div class="col-md-10 col-sm-6 col-xs-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10 col-sm-6 col-xs-12">
                    <input id="title" name="price" required="required" class="form-control col-md-7 col-xs-12" type="text" value="{{ $row->price }}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10 col-sm-6 col-xs-12">
                    <input id="title" type="file" name="image" class="form-control col-md-7 col-xs-12" type="text">
